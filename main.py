...
# CSS محسّن لمنع انعكاس الحروف وضبط اتجاه القوائم والنصوص تماماً للموبايل والحاسبة
st.markdown("""
    <style>
    /* توجيه التطبيق بالكامل يمين ليسار */
    .stApp {
        direction: rtl !important;
        text-align: right !important;
    }
    /* ضبط القائمة الجانبية لضمان عدم انعكاس الحروف وأسماء الأقسام */
...
if selected_tab == "➕ إضافة مادة":
    ...
    <div style="text-align: center; padding: 10px;">
        <h2>🌟 دليل استخدام نظام ياسر ويب الشامل</h2>
        <p style="color: gray;">المرجع السريع لإدارة المبيعات والمخازن بكفاءة عالية على الهواتف والأجهزة</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    guides = [
        ("➕ 1. إضافة مادة جديدة", "إدخال البضائع الجديدة للمخزن وتحديد أسعار الشراء والبيع والكميات بدقة."),
        ("📦 2. جرد المخزن والباركود", "عرض المواد والمنتجات مع الألوان، القياسات، الباركود، وطباعة الرموز."),
        ("👥 3. العملاء والديون", "تسجيل بيانات الزبائن ومعلومات التواصل ومتابعة حركة الديون المرتبطة بفواتيرهم."),
        ("💵 4. تسداد الديون", "إدخال الدفعات النقدية المسددة وتحديث أرصدة العملاء وتصفير الذمم."),
        ("🏭 5. الموردين", "تسجيل بيانات الموردين وأرقام هواتفهم والتخصصات المرتبطة بتوريد البضائع."),
        ("🛒 6. البيع والفواتير", "نافذة سلة المبيعات لتجميع المواد وتحديد الكميات وحساب المبالغ تلقائياً."),
        ("📄 7. سجل الفواتير", "عرض الفواتير الصادرة، تحميلها للطباعة المباشرة، أو إرسالها عبر الواتساب."),
        ("💰 8. المصاريف", "تسجيل النثريات والمصروفات اليومية لحساب صافي الصندوق بدقة."),
        ("📊 9. التقارير", "تحليلات مالية دقيقة لإجمالي المبيعات، صافي الأرباح، والديون المعلقة."),
        ("📜 10. سجل النشاطات", "سجل رقابي متكامل يوثق جميع عمليات المستخدمين بدقة عالية."),
        ("📖 11. الدليل والدعم", "المرجع الشامل والدعم الفني.")
    ]
    
    for title_g, desc_g in guides:
        with st.container(border=True):
            st.markdown(f"### {title_g}")
            st.write(desc_g)
            
    st.divider()
    st.markdown(f"<div style='text-align: center; color: gray;'>✨ تطوير البرمجة: نظام ياسر ويب | انستغرام: @yaser120120120120 © 2026</div>", unsafe_allow_html=True)
