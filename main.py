...
def main():
    ...
    # محاكاة تسجيل الدخول (نفس الكود القديم تماماً بدون تغيير)
    ...
    # محاكاة بيانات المبيعات والمخزون القديمة
    data = {
    ...
    # القائمة الجانبية للتنقل (كامل الأقسام القديمة)
    ...
    if menu == "لوحة التحكم والأرباح":
        ...
        # 📄 التحديث الوحيد المطلوب لعرض الفاتورة بوضوح ووضوح تام
